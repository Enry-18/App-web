...
namespace WebAppCRUD.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public AlumnosController(WebAppCRUDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ApePat,ApeMat,Semestre,Carrera")] Alumnos alumnos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ApePat,ApeMat,Semestre,Carrera")] Alumnos alumnos)
        {
            if (id != alumnos.Id)
            {
                return NotFound();
